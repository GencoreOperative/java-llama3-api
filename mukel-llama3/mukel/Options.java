...
public record Options(Path modelPath, String prompt, String systemPrompt, boolean interactive,
    ...
    public static final float DEFAULT_TOPP = 0.95f;
    ...
    static void printUsage(PrintStream out) {
        out.println("Usage:  jbang mukel.Llama3.java [options]");
        out.println();
        out.println("Options:");
        ...
        out.println("  jbang mukel.Llama3.java --model llama3-8b-q4_0.gguf --prompt \"Tell me a joke\"");
        out.println("  jbang mukel.Llama3.java --model llama3-8b-q4_0.gguf --system-prompt \"Reply concisely, in French\" --prompt \"Who was Marie Curie?\"");
        out.println("  jbang mukel.Llama3.java --model llama3-8b-q4_0.gguf --system-prompt \"Answer concisely\" --chat");
        out.println("  jbang mukel.Llama3.java --model llama3-8b-q4_0.gguf --chat");
        out.println("  jbang mukel.Llama3.java --model llama3-8b-q4_0.gguf --prompt \"Print 5 emojis\" --stream=false");
    }
